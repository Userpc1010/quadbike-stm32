...
//
//	Servo min and max values for Servos 100Hz
//
#define SERVO_MIN	360
#define SERVO_MAX	930
...
typedef enum
{
    PCA9685_OK              = 0,
    PCA9685_ERROR           = 1,
    PCA9685_ERROR_I2C_BUSY  = 2, // Шина занята другим устройством
    PCA9685_ERROR_NO_DEVICE = 3, // Чип не ответил по адресу 0x80
    PCA9685_ERROR_READ      = 4, // Ошибка чтения регистра (MODE1)
    PCA9685_ERROR_WRITE     = 5, // Ошибка записи (не применились настройки)
    PCA9685_ERROR_LOW_VOLT  = 6  // Регистр вернул 0xFF или 0x00 (нет питания чипа)
} PCA9685_STATUS;
